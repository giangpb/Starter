 ...
 */
public class SelectedDayReportItemsSpinner extends ArrayAdapter<String> {
    ...
    public SelectedDayReportItemsSpinner(@NonNull Context context, int resource) {
...
//        label.setText(mData[position]);
//
        if (position == ItemsReportFragment.posOfItemSpinnerSelected) {
